    ...
    <main className="bg-grey-800 flex flex-col md:flex-row h-screen items-center justify-center">
      <header className="flex flex-col gap-6 md:h-fit md:mr-8 text-grey-100 max-w-sm">
        <div className="flex flex-row gap-2 mt-4 items-center">
          ...
          />
          <strong
            className={`${genos.className} text-3xl font-medium md:text-5xl `}
          >
            Direct Whatsapp
          </strong>
        </div>
        <span className="text-lg md:text-xl mb-10 font-regular">
          Envie mensagens para números no Whatsapp sem a necessidade de
      ...
      <main className="flex flex-col items-center w-fit max-w-sm p-6 rounded-xl gap-6 bg-grey-600 h-fit">
        <form action="" className="flex flex-col gap-6">
          <div className="flex bg-grey-800 rounded-lg p-3 gap-2 text-grey-300 ">
            ...
            <input
              ...
              className="bg-grey-800 placeholder-grey-300 w-full"
            />
          </div>
          <div className="flex bg-grey-800 rounded-lg p-3 gap-2 text-grey-300 ">
            ...
            <textarea
              ...
              className="bg-grey-800 placeholder-grey-300 h-16"
            ></textarea>
          </div>
          <button
            type="submit"
        ...
        <a
          ...
          className="mt-4 text-grey-300 text-sm hover:underline"
        >
